...
local CharacterStats = {
  ...
  defaults = {
    ...
    distanceTraveledYds = 0, -- distance traveled in yards
...
function CharacterStats:ResetDistanceTraveled()
  local stats = self:GetCurrentCharacterStats()
  stats.distanceTraveledYds = self.defaults.distanceTraveledYds
  SaveDBData('characterStats', UltraHardcoreDB.characterStats)
  print('UHC - Distance traveled has been reset to ' .. self.defaults.xpGainedWithoutAddon)
end
...
SLASH_RESETDISTANCETRAVELED1 = '/resetdistancetraveled'
SlashCmdList['RESETXP'] = function()
  CharacterStats:ResetDistanceTraveled()
end
