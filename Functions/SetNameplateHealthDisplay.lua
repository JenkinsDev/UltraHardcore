...
function ProcessNameplate(nameplate)
  ...
  if modifiedNameplates[nameplate] then return end
...
function RestoreNameplate(nameplate)
  if not modifiedNameplates[nameplate] then return end
...
nameplateFrame:SetScript('OnEvent', function(self, event, unit)
  ...
  if not GLOBAL_SETTINGS or not GLOBAL_SETTINGS.disableNameplateHealth then return end
