...
-- Create the distance traveled text display
local distanceTraveledLabel = statsFrame:CreateFontString(nil, "OVERLAY", "GameFontHighlight")
distanceTraveledLabel:SetPoint("TOPLEFT", statsFrame, "TOPLEFT", 20, -95)
distanceTraveledLabel:SetText("Distance Traveled (yds):")

local distanceTraveledText = statsFrame:CreateFontString(nil, "OVERLAY", "GameFontHighlight")
distanceTraveledText:SetPoint("TOPRIGHT", statsFrame, "TOPRIGHT", -20, -95)
distanceTraveledText:SetText("0")
...
settingsSectionTitle:SetPoint("TOPLEFT", settingsFrame, "TOPLEFT", 20, -210)
...
for i = 1, 3 do
	...
	if i == 1 then
		button:SetPoint("LEFT", presetButtonsFrame, "LEFT", spacing, -30) -- Left
	elseif i == 2 then
		button:SetPoint("CENTER", presetButtonsFrame, "CENTER", 0, -30) -- Centered
	elseif i == 3 then
		button:SetPoint("RIGHT", presetButtonsFrame, "RIGHT", -spacing, -30) -- Right
	end
...
local function UpdateDisplayValues()
	...
	if distanceTraveledText then
		local distanceTraveledYds = CharacterStats:GetStat("distanceTraveledYds") or 0
		distanceTraveledText:SetText(string.format("%d", distanceTraveledYds))
	end
end
